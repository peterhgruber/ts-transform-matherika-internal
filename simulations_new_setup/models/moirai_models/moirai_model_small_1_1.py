...
# ------------------------------------------------------------------------------
# Moirai-1.1 forecast function (small)
# ------------------------------------------------------------------------------
def forecast_moirai(series, context_length=66, prediction_days=22, n_samples=100):
    """
    Forecast future paths from a univariate time series using Moirai-1.1 (small).
    ...
    # Initialize Moirai-1.1 forecasting model (small)
