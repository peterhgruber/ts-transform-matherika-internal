...
def main():
    """
    Forecast runner (Moirai 2.0 only):
    - Reads runfiles/forecast_*.txt
    - Selects only Moirai 2.0 jobs
    ...
    for runfile_path in runfiles:
        ...
        if model_name.startswith("moirai_model_small_2_0") or \
           model_name.startswith("moirai_model_base_2_0") or \
           model_name.startswith("moirai_model_large_2_0"):
